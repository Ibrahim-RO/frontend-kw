...
import { withEventsFirst } from '@/src/features/admin/homepage/events'
...
export default async function Home() {
  ...
  return <>
    ...
    <main>{withEventsFirst(page.sections).filter(s => s.visible).map((section,index) => <ManagedSection key={section.id} section={section} index={index}/>)}</main>

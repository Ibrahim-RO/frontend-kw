      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-8">
        <div>
          <h2 id="about-title" className="font-heading text-4xl font-extrabold tracking-tight text-kw-secondary sm:text-5xl lg:text-6xl">
            ¿QUÉ ES <span className="text-kw-primary">KW</span>?
          </h2>

          <div className="mt-8 max-w-2xl space-y-8 text-lg leading-8 text-kw-tertiary sm:text-xl">
            <p>
              <strong className="font-heading font-extrabold text-kw-secondary">EMPRESA NÚMERO 1 DE ENTRENAMIENTO</strong>, networking, aprendizaje y coaching para agentes inmobiliarios.
            </p>
            <p>
              Construye un negocio, no solo un empleo. Usa nuestros entrenamientos, sistemas y modelos probados.
            </p>
          </div>
          ...
          <div className="mt-10 flex flex-col gap-6 rounded-2xl border border-neutral-200 bg-neutral-50 p-6 sm:flex-row sm:items-center sm:p-7">
            ...
            <p className="text-lg leading-8 text-kw-secondary sm:text-xl">
              Programas de entrenamiento para <strong className="font-bold text-kw-primary">potencializar</strong> tu negocio.
            </p>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-neutral-200 bg-neutral-100 shadow-xl shadow-black/10">
          <Image
            src="/section-banner-image.png"
            alt="Profesionales inmobiliarios colaborando en una sesión de entrenamiento"
            width={1400}
            height={1050}
          ...
          <div className="absolute inset-x-0 bottom-0 p-7 sm:p-9">
            <p className="font-heading text-2xl font-extrabold text-white sm:text-3xl">Mentalidad de millonario</p>
            <p className="mt-1 text-sm font-bold uppercase tracking-[0.18em] text-kw-primary">Modelos probados desde 1983</p>
          </div>
        </div>
      </div>
    </section>
